  ...
  <div class="bg-gray-50 pt-12 sm:pt-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-4xl mx-auto text-center">
        <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">What could Lyrcs save you per song?<sup>* - link to research</sup></h2>
        <p class="mt-3 text-xl text-gray-500 sm:mt-4">Assuming a song written with a friend required rhyme searching and syllable counting.</p>
      </div>
    </div>
